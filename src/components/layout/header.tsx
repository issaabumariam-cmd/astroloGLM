      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="rounded-md p-2.5 text-foreground-muted hover:bg-surface-muted md:hidden"
      ...
      >
        <nav className="flex flex-col gap-1 px-4 py-4">
          ...
          <Link
            href="/pricing"
            onClick={() => setMobileOpen(false)}
            className="mt-2 rounded-full border border-border-strong bg-surface px-4 py-2.5 text-center text-sm font-medium text-foreground-muted"
          >
            Get Premium
          </Link>
        </nav>
