  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md flex-col items-center justify-center px-4 py-12">
      <div className="mb-6 text-center">
        ...
        <h1 className="heading-serif mt-3 text-2xl font-semibold text-foreground">Welcome Back</h1>
        <p className="mt-1 text-sm text-foreground-muted">Sign in to continue your journey</p>
      </div>
      ...
      <p className="mt-4 text-center text-sm text-foreground-muted">
        New here? <Link href="/auth/signup" className="font-medium text-primary hover:text-primary-hover">Create an account</Link>
      </p>
    </div>
  );
}